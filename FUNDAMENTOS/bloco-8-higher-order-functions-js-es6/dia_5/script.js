...
const personLikes = ({likes, name, age}) => `${name} is ${age} years old and likes ${likes.join(', ')}.`;
...
const filterPeople = (person) => {
  return person.filter(({bornIn, nationality}) => bornIn > 1900 && bornIn <= 2000 && nationality === 'Australian');
};
